...
- 本手册是 [Python cheat sheet](http://datasciencefree.com/python.pdf) 的中文翻译版。原作者：Arianne Colton and Sean Chen([data.scientist.info@gmail.com](mailto:data.scientist.info@gmail.com))
...
- [常规](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#常规)
- [数值类类型](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#数值类类型)
- [数据结构](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#数据结构)
- [函数](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#函数)
- [控制流](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#控制流)
- [面向对象编程](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#面向对象编程)
- [常见字符串操作](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#常见字符串操作)
- [异常处理](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#异常处理)
- [列表、字典以及元组的推导表达式](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#列表、字典以及元组的推导表达式)
- [单元测试](https://github.com/skywind3000/awesome-cheatsheets/blob/master/languages/python.md#单元测试)
